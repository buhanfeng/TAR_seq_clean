...
MERGEBP=$3
THRESH=$4
OUTDIR=$5 #DWM; STARsolo output directory path
...
bedtools bamtobed -i ${INPUT_BAM} -split | LC_ALL=C sort -k1,1V -k2,2n --parallel=${CORE} | awk '{print $0}' | gzip > ${TMPDIR}/${PREFIX}_split.sorted.bed.gz
